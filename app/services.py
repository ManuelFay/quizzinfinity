    ...
    def _resolve_generation_plan(
        ...
        *,
        ...
        prompt = (
            ...
            "Avoid unexplained abbreviations in prompts and options: on first mention, spell out the full term before any abbreviation. "
    ...
    def generate_error_lesson(
        ...
        *,
        ...
        prompt = (
            ...
            "Structure the teaching from high-level understanding first, then progressively add depth. "
            "Do not include a section about why wrong answers were tempting. "
            "Focus on helping the learner understand each question and the basis for why the correct answers are correct. "
            "Use this structure: "
            "(1) ## Big Picture, "
            "(2) ## Question Foundations with one subsection per missed question, "
            "(3) ## Deeper Dive, "
            "(4) ## Next Attempt Checklist. "
